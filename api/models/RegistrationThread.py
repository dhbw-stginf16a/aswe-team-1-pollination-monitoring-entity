...
class RegistrationThread:
    ...
    def __init__(self, centralNode, ownURL, concern):
        self.run = True
    ...
    def register(self):
        while self.run:
            ...
            try:
                r = requests.post("{}/monitoring".format(self.CENTRAL_NODE_BASE_URL), json = {"endpoint": self.OUR_URL, "concern": self.concern})
